...
void ghost_move(int ghost_path_size,int ghost_path[][ghost_path_size],int translate_row_col[],int map_row,int map_col,char map[][map_col+1],struct ghost_char *my_ghost_char){
    ...
    // }
    // map[translate_row_col[0]][translate_row_col[1]]='g';
    // map[my_ghost_char[1].ghost_row][my_ghost_char[1].ghost_col]=temp;
    // my_ghost_char[1].ghost_row=translate_row_col[0];
    // my_ghost_char[1].ghost_col=translate_row_col[1];  }  
}
