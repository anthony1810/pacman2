...
*/
void new_game_read_file(WINDOW *map_win,int row,int col,char map[row][col], char s[],char file_name[],struct pacman_char *my_pacman_char,int *ghost_row,int*ghost_col);
